...
Write-Host "========================================="
python -u run.py --is_training 1 --root_path "$DataDir/" --data_path combined_healthy_train.csv --model_id Brian2_Master --model iTransformer --data custom --features M --seq_len 30 --label_len 15 --pred_len 3 --e_layers 2 --enc_in 25 --dec_in 25 --c_out 25 --des 'Brian2_Exp' --d_model 64 --d_ff 128 --batch_size 32 --learning_rate 0.001 --train_epochs 10 --output_attention --do_predict --target brian2_sensor_4_4 --patience 3 --checkpoints "$ResultsDir/checkpoints/"
...
for ($i = 1; $i -le 10; $i++) {
    ...
    python -u run.py --is_training 0 --root_path "$DataDir/" --data_path "brian2_healthy_$i.csv" --model_id Brian2_Master --model iTransformer --data custom --features M --seq_len 30 --label_len 15 --pred_len 3 --e_layers 2 --enc_in 25 --dec_in 25 --c_out 25 --des 'Brian2_Exp' --d_model 64 --d_ff 128 --batch_size 32 --output_attention --do_predict --target brian2_sensor_4_4 --checkpoints "$ResultsDir/checkpoints/"
...
Write-Host "========================================="
for ($i = 1; $i -le 10; $i++) {
    Write-Host "   -> Inferring Unhealthy $i"
    python -u run.py --is_training 0 --root_path "$DataDir/" --data_path "brian2_unhealthy_$i.csv" --model_id Brian2_Master --model iTransformer --data custom --features M --seq_len 30 --label_len 15 --pred_len 3 --e_layers 2 --enc_in 25 --dec_in 25 --c_out 25 --des 'Brian2_Exp' --d_model 64 --d_ff 128 --batch_size 32 --output_attention --do_predict --target brian2_sensor_4_4 --checkpoints "$ResultsDir/checkpoints/"

    Move-InferenceResult "unhealthy_test\run_$i"
}
