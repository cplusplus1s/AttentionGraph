...
Write-Host "========================================="
python -u run.py --is_training 0 --root_path "$DataDir/" --data_path "matlab_unhealthy_1.csv" --model_id MSD_Master --model iTransformer --data custom --features M --seq_len 384 --label_len 192 --pred_len 192 --e_layers 3 --enc_in 24 --dec_in 24 --c_out 24 --des 'MSD_Exp' --d_model 128 --d_ff 128 --batch_size 128 --output_attention --do_predict --target mass_12_acc_y --checkpoints "$ResultsDir/checkpoints/"
