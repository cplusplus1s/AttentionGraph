...
python -u run.py --is_training 1 --root_path "$DataDir/" --data_path "matlab_healthy_30.csv" --model_id MSD_SpatialPE --model iTransformer --data custom --features M --seq_len 384 --label_len 192 --pred_len 192 --e_layers 3 --enc_in 24 --dec_in 24 --c_out 24 --des "MSD_Exp" --d_model 128 --d_ff 128 --batch_size 128 --learning_rate 0.001 --itr 1 --train_epochs 10 --target mass_12_acc_y --patience 5 --lradj "type2" --checkpoints "$ResultsDir/checkpoints/" --use_spatial_pe
...
# Move-InferenceResult "unhealthy\run_1" "MSD_SpatialPE"